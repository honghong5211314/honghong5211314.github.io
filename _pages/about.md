...
*   Developed a robust deep learning model to solve [Specific Task, e.g., image classification/prediction] problems.
*   Optimized the model architecture (e.g., using Transformers/CNNs) to balance accuracy and inference speed.
...
*   **AI Frameworks:** PyTorch, TensorFlow (Familiar with model implementation)
